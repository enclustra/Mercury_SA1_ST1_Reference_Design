...
# LEDs
set_false_path -from * -to [get_ports {LED0_N}]
set_false_path -from * -to [get_ports {LED1_N}]
set_false_path -from * -to [get_ports {LED2_N}]
set_false_path -from * -to [get_ports {LED3_N}]
...
create_clock -period "50 MHz" [get_ports CLK_FPGA]
...
set_false_path -from * -to [get_ports {ETH_MDC}]
set_false_path -from * -to [get_ports {ETH_MDIO}]
set_false_path -from * -to [get_ports {ETH_TXD0}]
set_false_path -from * -to [get_ports {ETH_TXD1}]
set_false_path -from * -to [get_ports {ETH_TXD2}]
set_false_path -from * -to [get_ports {ETH_TXD3}]
set_false_path -from * -to [get_ports {ETH_TX_CLK}]
set_false_path -from * -to [get_ports {ETH_TX_CTL}]
...
set_false_path -from [get_ports {ETH_RXD0}] -to *
set_false_path -from [get_ports {ETH_RXD1}] -to *
set_false_path -from [get_ports {ETH_RXD2}] -to *
set_false_path -from [get_ports {ETH_RXD3}] -to *
set_false_path -from [get_ports {ETH_RX_CLK}] -to *
set_false_path -from [get_ports {ETH_RX_CTL}] -to *
